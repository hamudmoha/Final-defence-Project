...
export default function AICopilot() {
  ...
  const [messages, setMessages] = useState(() => {
    ...
    return [
      {
        role: 'assistant',
        content: 'Hello! I am your Management AI Copilot. How can I help you today? I can help you analyze the dashboard, write reports, or check system health.'
      }
    ];
  });
  ...
  const isAdminRoute = location.pathname.includes('/manager-dashboard') || location.pathname.includes('/super-admin');
  const aiRole = location.pathname.includes('/super-admin') ? 'sysadmin' : 'manager';
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      let errorText = "Ah, it seems my connection to the AI matrix was interrupted.";
  ...
  const predefinedPrompts = [
    ...
    "Show me the system audit report",
    "How to manage tents"
  ];
      ...
      >
        <div className="bg-gradient-to-r from-teal-600 to-teal-800 p-4 flex items-center justify-between shadow-md z-10 shrink-0">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="font-bold text-white leading-none">{aiRole === 'sysadmin' ? 'System Admin Copilot' : 'Manager AI Copilot'}</h3>
              <span className="text-xs text-teal-100 flex items-center gap-1 mt-1">
                <span className="w-2 h-2 rounded-full bg-cyan-400"></span> Online
              </span>
            </div>
          </div>
          <div className="flex items-center gap-1">
            <button 
              onClick={() => setMessages([{ role: 'assistant', content: 'Hello! I am your Management AI Copilot. How can I help you today? I can help you analyze the dashboard, write reports, or check system health.' }])}
        ...
        <div className="p-4 bg-white shrink-0 border-t border-slate-100">
          ...
          <div className="relative flex items-center gap-2">
            ...
            <div className="relative flex-1 flex items-center">
              <textarea
                ...
                placeholder={selectedFile ? "Add a message about this file..." : "Ask your management copilot..."}
          ...
          <div className="text-center mt-2 flex items-center justify-center gap-1">
            ...
            <p className="text-[10px] text-slate-400">AI can now analyze logs, reports, and screen outputs.</p>
          </div>
        </div>
      </div>
    </>
